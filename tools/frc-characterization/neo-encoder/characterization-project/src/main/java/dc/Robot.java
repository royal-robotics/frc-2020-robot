...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    leftEncoder.setPositionConversionFactor(encoderConstant);
    leftEncoder.setVelocityConversionFactor(encoderConstant);
    ...
    rightEncoder.setPositionConversionFactor(encoderConstant);
    rightEncoder.setVelocityConversionFactor(encoderConstant);
    ...
    leftEncoderRate = ()
        -> leftEncoder.getVelocity() / 60.;

    rightEncoderPosition = ()
        -> -rightEncoder.getPosition();
    rightEncoderRate = ()
        -> -rightEncoder.getVelocity() / 60.;
